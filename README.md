...
A [Wikipedia](https://en.wikipedia.org/ "Wikipedia") coordinate tag generator. This [bookmarklet](https://en.wikipedia.org/wiki/Bookmarklet) creates a `{{coord}}` tag based on a point on a Google map. [More on Wikipedia geo-tagging](https://en.wikipedia.org/wiki/Wikipedia:WikiProject_Geographical_coordinates).
